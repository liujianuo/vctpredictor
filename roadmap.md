...
### M10. Chronological split + walk-forward CV
Most recent ~15–20% held out; rolling-origin CV inside the training window; a
third disjoint slice reserved for calibration fitting (M26 must not see train or
final-eval data). Shared by every stage.
- Size: **M**
- Depends on: M8

### M11. Proper scoring rules library
...
thresholds, fit on the calibration slice from M10. No resampling or class
reweighting anywhere — those improve accuracy while destroying the base rate.
- Size: **M**
- Depends on: M20, M10
